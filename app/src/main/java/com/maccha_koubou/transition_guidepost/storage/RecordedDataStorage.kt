...
val e2Data = TestData("雌二醇", White, Icons.Filled.Star, e2Unit, e2FeminizationRecommendation, true, false, null)
val tData = TestData("睾酮", White, Icons.Filled.Star, tUnit, tFeminizationRecommendation, true, false, null)